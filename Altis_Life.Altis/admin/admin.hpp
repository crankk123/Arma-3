class admin_dialog {
	...
	{	
		...
		class admin_kick: Life_RscButtonMenu
		{
			...
			h = 0.022 * safezoneH;
			onButtonClick = "serverCommand ""#login eins""; [] spawn life_fnc_adminkick";
		...
		class admin_spectate: Life_RscButtonMenu
		{
			...
			action = "[] spawn life_fnc_admin_spectate;";
		};
		...
		{
			idc = 2417;
			text = "Port-Auswahl"; //--- ToDo: Localize;
			x = 0.592812 * safezoneW + safezoneX;
			y = 0.599 * safezoneH + safezoneY;
			w = 0.139219 * safezoneW;
			h = 0.022 * safezoneH;
			action = "closeDialog 0; [] spawn life_fnc_admin_tele;";

...
switch (_shop) do
{
	case "market": {["Markt",["water","axe","rabbit","apple","storagebig","storagesmall","bottledbeer","bottledwhiskey","redgull","battery","tbacon","lockpick","pickaxe","zipties","peach","boltcutter","blastingcharge"]]};
	...
	case "schwarzpulver": {["Schwarzpulver Dealer",["schwarzpulver"]]};
	case "cop": {["Polizei Austattung",["donuts","coffee","spikeStrip","mauer","battery","painkillers","redgull","defusekit"]]};
	...
	case "fbi": {["FBI Austattung",["donuts","coffee","spikeStrip","mauer","battery","painkillers","redgull","defusekit"]]};
	case "baumarkt": {["Baumarkt",["holz","axt"]]};
};